...
try {
    $stmt = $pdo->prepare("SELECT c.course_code, c.course_name, g.grade, g.semester, g.academic_year FROM grades g 
                          INNER JOIN courses c ON g.course_id = c.id 
                          WHERE g.student_id = ? ORDER BY g.academic_year DESC, g.semester DESC");
...
<head>
  ...
  <title>Grades - CPSU Portal</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .grade-badge.a { background: rgba(85, 107, 47, 0.15); color: var(--olive); }
    .grade-badge.b { background: rgba(198, 169, 97, 0.15); color: var(--gold); }
    .grade-badge.c { background: rgba(255, 193, 7, 0.15); color: #c7a000; }
    .grade-badge.d { background: rgba(255, 152, 0, 0.15); color: #e65100; }
    .grade-badge.f { background: rgba(244, 67, 54, 0.15); color: #c62828; }
  ...
  <main class="main-content">
    <header class="header">
      <div>
        ...
        <p class="header-subtitle">View your academic performance and grades.</p>
      </div>
    </header>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="grade-badge <?php echo strtolower($grade['grade']); ?>"><?php echo htmlspecialchars($grade['grade']); ?></span></td>
